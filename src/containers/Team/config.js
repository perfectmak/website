...
const config = {
  teamMembers: [
    ...
    },
    {
      ...
      bio:
        'Collins has been trading and investing in financial markets since he was an early teenager. He has successfully managed development groups solving complex problems in financial markets. As a market professional, he understands the demands of an exchange user.'
    },
    {
      ...
      bio:
        'Perfect is passionate about building smart solutions related to Android, AI and Smart Contracts in order to make people’s lives better. He also has experience with machine learning, image processing and web applications (backends with PHP and Node.js).'
    },
    {
      name: 'Eswara Sai',
      ...
      bio:
        'Eswara is a passionate Frontend Developer proficient working with HTML, CSS & JavaScript. He is also experienced with JavaScript frameworks such as ReactJS and AngularJS which are majorly used in building dynamic single-page web applications.'
    },
    {
