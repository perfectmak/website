        ...
        <Row type="flex" align="middle">
          ...
          >
            <Wrapper bg="#fff" padded>
              ...
              <MarketList>
                gain cross-chain exposure without taking custody of the
                underlying asset
              </MarketList>
              <MarketList>
        ...
        <Row type="flex" align="middle">
          <Col xs={24} sm={24} md={8} lg={8} xl={8}>
            <Wrapper bg="#fff" padded>
              ...
              <MarketList>
                recreate traditional off-chain relationships like AAPL/USDT
                using stable coins such as Tether or Maker Dai
              </MarketList>
            </Wrapper>
          </Col>
          <Col xs={12} sm={12} md={8} lg={8} xl={8}>
